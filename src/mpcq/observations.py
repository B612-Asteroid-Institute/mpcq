...
class MPCObservations(qv.Table):
    ...
    # keep single definitions of permid/provid
    permid = qv.LargeStringColumn(nullable=True)
    provid = qv.LargeStringColumn(nullable=True)
    ...
    datastream_metadata_uuid = qv.LargeStringColumn(nullable=True)
    datastream_metadata_source_timestamp = qv.Int64Column(nullable=True)
